...
public class EntityRingTailedLemur extends EntityShoulderRiding implements IEntityAnimated
{

    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityRingTailedLemur.class, DataSerializers.VARINT);
    private EntityAIAvoidEntity<EntityPlayer> avoidEntity;
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;
	private boolean calling;

    public EntityRingTailedLemur(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(8, new EntityOnShoulder(this));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityRingTailedLemur.class);
    }
    ...
    protected SoundEvent getAmbientSound()
    {
        if (this.isTamed())
        {
            if (this.isInLove())
            {
                return SoundEvents2.LEMUR;
            }
            else
            {
            	return this.rand.nextInt(4) == 0 ? SoundEvents2.LEMUR : SoundEvents2.LEMUR;
            }
    ...
    public EntityRingTailedLemur createChild(EntityAgeable ageable)
    {
        EntityRingTailedLemur entityocelot = new EntityRingTailedLemur(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityRingTailedLemur))
        {
            return false;
        }
        else
        {
            EntityRingTailedLemur entityocelot = (EntityRingTailedLemur)otherAnimal;
